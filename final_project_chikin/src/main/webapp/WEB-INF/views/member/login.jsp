...
<div class="container">
    ...
    <c:if test="${not empty rememberCookie.getValue()}">
        ...
        <div class="api_signup">
            <a href="/oauth2/authorization/google"><img src="/resources/img/g_bt1.png"></a><br>
            <a href="/oauth2/authorization/naver"><img src="/resources/img/n_bt2.png"></a><br>
            <a href="/oauth2/authorization/kakao"><img src="/resources/img/k_bt1.png"></a>
        </div>
    </form>
</div>
</body>
