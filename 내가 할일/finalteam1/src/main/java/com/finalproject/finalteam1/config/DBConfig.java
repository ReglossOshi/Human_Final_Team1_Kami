package com.finalproject.finalteam1.config;
...
@Configuration
@ComponentScan(basePackages = "com.finalproject.finalteam1.service")
@MapperScan(basePackages = {"com.finalproject.finalteam1.mapper"})
