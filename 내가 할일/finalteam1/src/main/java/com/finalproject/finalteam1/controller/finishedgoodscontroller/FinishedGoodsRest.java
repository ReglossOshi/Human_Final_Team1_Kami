...
public class FinishedGoodsRest {
    ...
    @RequestMapping(method = {RequestMethod.PUT,RequestMethod.PATCH},
            value = "/name/{name}/price/{price}",consumes = "application/json",
            produces = {MediaType.TEXT_PLAIN_VALUE})
    public ResponseEntity<String> goodsUpdate(@PathVariable("name") String name,@PathVariable("price") int price){
