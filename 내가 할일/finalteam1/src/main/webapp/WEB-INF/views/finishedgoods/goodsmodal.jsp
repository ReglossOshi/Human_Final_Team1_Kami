                            ...
                            <div class="goods-inner">
                                ...
                                <div class="goods-detail-btn">
                                    <div id="goods-detail-btnmenu">
                                        ...
                                        <button class="btn btn-sm btn-danger ml-2 mt-2" onclick="goodsDelete()">삭제</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="goods-modal">
                        <div class="goods-insert">
                            <div class="modal-input-box">
                                ...
                                <div class="modal-input">
                                    <button class="btn btn-sm btn-secondary ml-2 mt-2" id="storagePlusBtn" onclick="test13()">추가</button>
                                </div>
                            </div>
                            <div class="modal-input-box">
                                <div class="map_wrap">
...
function goodsUpdate(){
    ...
    console.log(goodsDetailStatus);

    goodsStatusChange(goodsDetailName, goodsDetailPrice, goodsDetailStatus);
...
function storageValue(snum){
    console.log(mapLi[snum-1].getElementsByClassName('info')[0].getElementsByTagName('h5')[0].innerHTML);
    console.log(mapLi[snum-1].getElementsByClassName('info')[0].getElementsByTagName('span')[0].innerHTML);
