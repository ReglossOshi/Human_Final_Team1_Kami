                ...
                <div class="row" style="height:500px;">
                    <div class="inven-modal-container">
                        <div class="inven-modal-contents">
                            ...
                            <div class="inven-input">
                                <div class = "inputDivBox">
                                    <input class = "inputBox" type="text" id="inven-detail-count" required>
                            ...
                            <div class="inven-input">
                                <div class = "inputDivBox">
                                    <input class = "inputBox" type="text" id="" required>
                                    <label class = "inputLabelTag">재고 날짜</label>
                                    <span class = "inputSpanTag" id="inputtext"></span>
                                </div>
                            </div>
                            <div class="inven-input">
                            ...
                            <div class="inven-input">
                                <div class="inven-modal-btn">
                                    <button class="btn btn-sm btn-secondary ml-2 mt-2" id="" onclick="availability();">출고</button>
                                </div>
                            </div>
                        </div>
                        <div class="inven-modal-contents">
                            ...
                            <div class="inven-page">
                                <div class="pagination__wrapper">
                                    <ul class="pagination">
                                        <li class='pagelist'><button class='pagebtn prev'>&#10094;</button></li>
                                        <li class='pagelist'><button class='pagebtn pagenum active'>1</button></li>
                                        <li class='pagelist'><button class='pagebtn pagenum'>2</button></li>
                                        <li class='pagelist'><button class='pagebtn next'>&#10095;</button></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
...
function availability(){
    ...
    for(let i=1;i<rowList.length;i++){
        var row = rowList[i];
        var row_count = row.cells[2].innerHTML;
